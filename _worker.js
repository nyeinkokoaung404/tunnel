...
let userID = '4480d21c-0569-438e-a656-2d08e69c94b6';
...
<a href='${subbestip}' target='_blank'>VLESS node subscription connection (V2rayU, V2rayN and other tools) preferred IP</a>
<button onclick='copyToClipboard("${subbestip}")'><i class="fa fa-clipboard"></i> Copy Vless Node Subscription</button>
